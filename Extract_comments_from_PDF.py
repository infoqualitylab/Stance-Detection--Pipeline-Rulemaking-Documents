"""
This code utilises ADOBE PDF extract API to convert contents of the pdf into a parsable JSON structure
...
input_pdf = "PDFs/Section13_comments_shortened2.pdf"
# Opening JSON file
f = open('API-cred/pdfservices-api-credentials.json')
